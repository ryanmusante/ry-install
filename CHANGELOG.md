ry-install changelog — newest first; bullets are `<subsystem>: <change>`.

# 7.22.7 - 2026-06-07
- docs: correct atomic-write order (backup precedes `mv -T`; restore is post-write).
- docs: reformat changelog to kernel.org style.
- style: tighten longest inline comments to vital information.

# 7.22.6 - 2026-06-07
- services: skip enabling NetworkManager-dispatcher when preset is static (matches verify).

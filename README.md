...
[![version](https://img.shields.io/badge/version-4.4.2-blue.svg)](CHANGELOG.md)
...
```json
{"ts":"2026-04-25T14:23:01-0700","event":"header","version":"4.4.2","profile":"gtr9_pro","mode":"install","verbose":false,"command":"./ry-install.fish"}

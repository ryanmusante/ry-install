...
multi-user provisioning, non-CachyOS distros, laptops.
...
| `logind.conf.d` | Ignore 9 power/suspend/reboot keys (8 on systemd 252–255) |
...
| Credentials | Secret-flag patterns redacted in logs (case-insensitive long forms) |
...
| Log integrity | NDJSON to `~/ry-install/logs/YYYY-MM-DD/*.jsonl`; rotation-race self-heal |
